...
const skills = [
  ...
  { category: 'CI/CD & Automation', icon: GitBranch, items: ['Azure DevOps', 'Jenkins', 'GitHub Actions', 'MLOps', 'Microservice Deployment', 'Monolithic Deployment', 'Frontend CI/CD', 'Backend CI/CD'] },
