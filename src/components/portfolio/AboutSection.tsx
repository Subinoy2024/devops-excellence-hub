      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="md:col-span-2 space-y-4 text-muted-foreground leading-relaxed">
            <p>
              Cloud & DevOps Engineering with 13+ years of IT experience delivering end-to-end cloud solutions across Terraform, Multi-Cloud Infrastructure, Kubernetes Platforms, CI/CD Automation, and AI-Driven Operational Workflows—building scalable, secure, and production-ready platforms.
            </p>
            <p>
