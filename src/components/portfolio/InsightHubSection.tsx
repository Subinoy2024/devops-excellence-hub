      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-sm max-w-xl mx-auto">
            Practical perspectives on cloud infrastructure, DevOps delivery, and platform engineering drawn from real-world enterprise experience.
          </p>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {articles.map((article, i) => (
            ...
            >
              ...
              <span className="inline-flex items-center gap-1 text-[11px] text-primary font-medium opacity-0 group-hover:opacity-100 transition-opacity">
