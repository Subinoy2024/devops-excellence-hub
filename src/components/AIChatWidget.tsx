...
const knowledge: Record<string, string> = {
  'who|name|about|introduction': "I'm Subinoy Debnath — a Cloud & DevOps Engineer with 12+ years of IT experience and 6+ years specializing in Cloud & DevOps. I build scalable, resilient, and secure cloud platforms for enterprise clients.",
